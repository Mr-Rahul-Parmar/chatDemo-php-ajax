        ...
        <li class="nav-item" style="margin-top: -15px">
            <a href="#" role="button" aria-expanded="false" style="position:relative; padding-left:50px;">
                ...
                @foreach($avatar as $img)
                    @if($img == "")
                        <img src='https://bootdey.com/img/Content/avatar/avatar7.png' alt='No Image In'
                             style="width:45px; height:45px; position:absolute; top:10px; left:10px; border-radius:50%">
                    @elseif(strpos($img, "http") === 0)
                        <img src='{{$img}}' alt='No Image'
                             style="width:45px; height:45px; position:absolute; top:10px; left:10px; border-radius:50%">
                    @else
                        <img src='{{url('/avatars/'.$img)}}' alt='No Image'
                             style="width:45px; height:45px; position:absolute; top:10px; left:10px; border-radius:50%">
                    @endif
                @endforeach
            </a>
